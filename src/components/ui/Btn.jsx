...
export const Btn = ({ href, onClick, type, children, variant = "solid", full = false, style: s, ...props }) => {
  ...
  const base = { fontFamily: "'Syne',sans-serif", fontSize: "0.86rem", fontWeight: 700, padding: "12px 26px", borderRadius: 100, textDecoration: "none", display: "inline-block", transition: "all .18s", border: "2px solid transparent", width: full ? "100%" : "auto", textAlign: "center", cursor: props.disabled ? "not-allowed" : "pointer", ...s };
  const vs = {
