...
export const SHead = ({ eyebrow, title, sub, center=false }) => (
  <div style={{ textAlign:center?"center":"left" }}>
    ...
    <Reveal delay={60}><h2 style={{ fontFamily:"'Poppins',sans-serif", fontSize:"clamp(1.8rem,4vw,3rem)", fontWeight:800, lineHeight:1.1, letterSpacing:"-0.025em", color:C.navy, maxWidth:center?"none":640 }} dangerouslySetInnerHTML={{__html:title}}/></Reveal>
