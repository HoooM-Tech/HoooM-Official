...
export const CTABand = () => {
  ...
  return (
    <section id="cta-band" style={{ padding:`80px ${isTab?"20px":"56px"}`, background:C.navy, textAlign:"center", position:"relative", overflow:"hidden" }}>
      ...
      <Reveal>
        <h2 style={{ fontFamily:"'Syne',sans-serif", fontSize:`clamp(1.8rem,${isTab?"6vw":"5vw"},4rem)`, fontWeight:800, color:"#fff", lineHeight:1.05, letterSpacing:"-0.03em", position:"relative", zIndex:1 }}>
          Let's build something<br/><span style={{ fontStyle:"italic", fontFamily:"'Instrument Serif',serif", fontWeight:400, color:C.orange }}>valuable together.</span>
        </h2>
      </Reveal>
