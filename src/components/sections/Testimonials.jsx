...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" style={{ padding:`80px ${isTab?"20px":"56px"}`, background:C.white }}>
      <SHead eyebrow="Testimonials" title={`What clients <span style="font-style:italic;font-family:'Poppins',sans-serif;font-weight:400;color:${C.orange}">say.</span>`}/>
        ...
        {testis.map((t,i)=>(
          <Reveal key={i} delay={i*70}>
            <div style={{ background:C.off, borderRadius:18, padding:"28px 26px" }}>
              <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"2.2rem", color:C.orange, lineHeight:1, marginBottom:12 }}>"</div>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                ...
                <div>
                  <div style={{ fontFamily:"'Poppins',sans-serif", fontSize:"0.84rem", fontWeight:700, color:C.navy }}>{t.name}</div>
