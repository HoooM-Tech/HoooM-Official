...
/* ── TESTIMONIALS ── */
const testis = [
  { q:"HoooM delivered a digital product that transformed how we operate. Professional, creative, and deeply committed to getting it right.", name:"Client Name", role:"CEO · Tech by HoooM client" },
  { q:"Orbbit gave our brand a completely new identity. The strategy was sharp, the execution flawless. We saw real growth from day one.", name:"Client Name", role:"Founder · Orbbit by HoooM" },
