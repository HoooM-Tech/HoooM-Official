  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <div style={{ padding: "20px" }}>
        <div style={{ fontFamily: "'Poppins',sans-serif", fontSize: "0.66rem", fontWeight: 700, color: C.orange, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }}>{tag}</div>
        <div style={{ fontFamily: "'Poppins',sans-serif", fontSize: "1rem", fontWeight: 700, color: C.navy, lineHeight: 1.3, marginBottom: 8 }}>{title}</div>
...
export const Insights = () => {
  ...
  return (
    <section id="insights" style={{ padding:`80px ${isTab?"20px":"56px"}`, background:C.white }}>
      <SHead eyebrow="Insights" title={`Thinking out <span style="font-style:italic;font-family:'Poppins',sans-serif;font-weight:400;color:${C.orange}">loud.</span>`}/>
